    ...
    public function store(Request $request) {
        ...
        if ($vendor) {
            ...
            if (auth()->user()->can('order.create')) {
                ...
                $order->paid_amount_online = $request->paid_amount_online;
                $order->change_amount = $request->paid_amount + $request->paid_amount_online - Cart::subtotal() + $discount + $member_discount_amount + $redeem_points_amount - $order->extra_charge;
