...
Route::group(['prefix' => '/home', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'sell', 'as' => 'sell.'], function () {
        ...
        Route::get('/export-excel/{all}', [App\Http\Controllers\OrderController::class, 'sell_export_excel2'])->name('export.excel');
    ...
    Route::group(['prefix' => 'vat-entry', 'as' => 'vat_entry.'], function () {
        ...
        Route::get('/search', [App\Http\Controllers\VatEntryController::class, 'search'])->name('search');
        Route::post('/paid/{id}', [App\Http\Controllers\VatEntryController::class, 'paid'])->name('paid');
