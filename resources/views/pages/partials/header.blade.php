...
<header class="header-area {{Route::currentRouteName() == "index" ? "transparent-bar" : "border-bottom-1"}} section-padding-1">
    <div class="top-menu">
    <div class="left-part">
        <span>
    ...
    <div class="right-part">
        <span>
            ...
            <div class="header-bottom {{Route::currentRouteName() == "index" ? "background-rgb-1" : ""}}">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-8 col-lg-8 d-flex justify-content-center position-static">
                            <div class="main-menu menu-lh-1 {{Route::currentRouteName() == "index" ? "main-menu-white" : ""}} main-menu-padding-1 menu-fw-400">
                                @include('pages.partials.nav')
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-2">
                            <div class="header-right-wrap header-right-flex">
                                <div class="same-style {{Route::currentRouteName() == "index" ? "same-style-white" : ""}} header-wishlist">
                                    <a href="{{ route('customer.account') }}"><i class="fa fa-heart-o"></i></a>
                                </div>
                                <div class="same-style {{Route::currentRouteName() == "index" ? "same-style-white" : ""}} cart-wrap">
                                    <a href="#" class="cart-active">
                                        <i class="dlicon shopping_bag-20"></i>
                                        <span class="count-style" id="total_count">{{ Cart::count() }}</span>
                                    </a>
                                </div>
                                <div class="same-style {{Route::currentRouteName() == "index" ? "same-style-white" : ""}} header-search">
                                    <a class="search-active" href="#">
                                        <i class="dlicon ui-1_zoom"></i>
                                    </a>
                                </div>
                                <div class="same-style {{Route::currentRouteName() == "index" ? "same-style-white" : ""}} header-off-canvas">
                ...
                <div class="row align-items-center">
                    <div class="col-6">
                        <div class="mobile-logo logo-width">
                            <a href="{{ route('index') }}">
                                <img alt="" src="{{ asset('images/website/'.$business->footer_logo) }}">
                            </a>
                        </div>
                    </div>
                    <div class="col-6">
