	...
	<div class="container-fluid">
		<div class="card">
              <div class="card-header">
                <a href="#addModal" class="btn btn-primary" data-toggle="modal"><i class="fas fa-plus"></i> Create partner</a>
                <a href="{{ route('partnertransaction.index') }}" class="btn btn-success"><i class="fas fa-eye"></i> Partner's Transactios</a>
              </div>
              <!-- /.card-header -->
