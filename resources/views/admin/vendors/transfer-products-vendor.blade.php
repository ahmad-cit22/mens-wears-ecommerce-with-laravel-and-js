...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Product Transfer to Other Vendors</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <form id="stockForm" action="{{ route('vendor.transfer_products.vendor.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control  @error('vendor_id') is-invalid @enderror" name="vendor_id" id="vendor_id" required>
                                        <option value="">---- Select Receiver Vendor ----</option>
                                        @foreach ($vendors as $vendor)
                                            @if ($vendor->is_active == 1 && $vendor->id != Auth::user()->vendor->id)
