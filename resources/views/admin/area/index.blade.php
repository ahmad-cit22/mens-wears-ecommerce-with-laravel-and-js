	...
	<div class="container-fluid">
		<div class="card">
              <div class="card-header">
                ...
                @endcan
                <!-- <a href="{{ route('area.upload') }}" class="btn btn-secondary"><i class="fas fa-plus"></i> Upload Area</a> -->
              </div>
              <!-- /.card-header -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label>Apply Shipping Charge *</label>
                                  <select name="location" class="form-control @error('location') is-invalid @enderror" required>
                                    <option value="1" {{ $area->location == 1 ? 'selected' : '' }}>Inside Dhaka</option>
                                    <option value="2" {{ $area->location == 2 ? 'selected' : '' }}>Dhaka Nearby</option>
                                    <option value="3" {{ $area->location == 3 ? 'selected' : '' }}>Outside Dhaka</option>
                                  </select>
                                  @error('location')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select name="location" class="form-control @error('location') is-invalid @enderror" required>
                            ...
                            <option value="2">Dhaka Nearby</option>
