	...
	<div class="container-fluid">
		<div class="card">
              <div class="card-header">
                @can('setting.create')
                <a href="#addModal" class="btn btn-primary" data-toggle="modal"><i class="fas fa-plus"></i> Create Accessory</a>
                <a href="{{ route('accessorystock.index') }}" class="btn btn-success"><i class="fas fa-eye"></i>Accessory Stock</a>
                @endcan
              </div>
              <!-- /.card-header -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="opening_amount" class="form-control @error('opening_amount') is-invalid @enderror" placeholder="opening amount">
