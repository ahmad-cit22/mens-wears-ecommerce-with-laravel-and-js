                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" name="reduction_amount" class="form-control @error('reduction_amount') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" name="reduction_period" class="form-control @error('reduction_period') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" name="depreciation_value" class="form-control @error('depreciation_value') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="date" name="purchase_date" class="form-control @error('purchase_date') is-invalid @enderror" required>
                        @error('purchase_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
