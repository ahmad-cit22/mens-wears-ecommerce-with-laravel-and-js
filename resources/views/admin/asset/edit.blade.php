                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="depreciation_value" class="form-control @error('depreciation_value') is-invalid @enderror" value="{{ $asset->depreciation_value }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Estimated Life*(in month)</label>
                                    <input type="number" name="estimated_life" class="form-control @error('estimated_life') is-invalid @enderror" value="{{ $asset->estimated_life }}" placeholder="Estimated Life in Month" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="depreciation_date" class="form-control @error('depreciation_date') is-invalid @enderror" value="{{ $asset->depreciation_date }}" placeholder="Monthly Date for Depreciation (Ex: 31)" max="31">
