...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">{{ __('app.roleEdit') }}</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="name" value="{{ explode('#', $role->name)[0] }}" class="form-control @error('name') is-invalid @enderror" required>
                @error('name')
              ...
              <div class="form-group">
                    ...
                    <div class="row col-md-12 {{ $group->group_name }} ml-2">
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="permissionCheckbox{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}>
