...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">{{ __('app.userList') }}</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('app.menu.home') }}</a></li>
          <li class="breadcrumb-item active">{{ __('app.userList') }}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
	...
	<div class="container-fluid">
		<div class="card">
              <div class="card-header">
                @can('user.create')
                  <a href="{{ route('user.create') }}" class="btn btn-primary">{{ __('app.action.create') }} <i class="fas fa-plus"></i></a>
                @endcan
              </div>
              <!-- /.card-header -->
