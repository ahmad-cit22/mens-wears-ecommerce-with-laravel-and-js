                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order->order_product as $key => $order_product)
                                            ...
                                            <tr>
                                                <td>{{ $loop->index + 1 }}
                                                    @if ($order_product->stock()->qty < 1)
                                                        <span class="ml-1 p-2 badge badge-danger">Stock Out</span>
                                                    @endif
                                                </td>
                                                @if ($order_product->product != null)
                                                    <td>
                                                        <div class="selectmain">
                                                            <select name="product[]" class="select2 select-down" id="" style="width: 75% !important;">
