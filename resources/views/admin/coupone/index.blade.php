                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="purchase_amount" class="form-control @error('purchase_amount') is-invalid @enderror" required>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
	                  @foreach($coupons as $coupon)
                        ...
                        <td>{{ Carbon\Carbon::parse($coupon->created_at)->format('d M, Y g:iA') }}</td>
                        <td>
                          @can('coupon.edit')
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label>Minimum Purchase Amount*</label>
                                      <input type="text" name="purchase_amount" value="{{ $coupon->purchase_amount }}" class="form-control @error('purchase_amount') is-invalid @enderror" required>
                                      @error('purchase_amount')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
