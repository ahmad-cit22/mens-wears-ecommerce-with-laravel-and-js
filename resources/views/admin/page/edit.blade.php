...
@section('content')
    ...
    @endif -->
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" placeholder="Add Meta Description Here" rows="5">{{ $page->meta_description }}</textarea>
